                ...
                <div class="col-md-12">
                    ...
                    <table class="table">
                        ...
                        @foreach (Cart::instance('default')->content() as $item )
                            ...
                            <tr>
                                <td><img src="{{ url('/images') . '/'. $item->model->image }}" style="width: 5em"></td>
                                <td>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table">
                            ...
                            @foreach (Cart::instance('saveForLater')->content() as $item )
                                ...
                                <tr>
                                    <td><img src="{{ url('/images') . '/'. $item->model->image }}" style="width: 5em">
                                    </td>
                                    <td>
                                        <strong>{{ $item->model->name }}</strong><br> {{ $item->model->description }}
                                    </td>
...
@section('script')
   ...
   <script src="{{ asset('js/app.js') }}"></script>  <!--Script for axios -->
    <script>
