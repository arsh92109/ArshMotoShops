        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <form method="post" id="payment-form" action="{{ route('checkout') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="address_line1" name="address_line1" placeholder="1234 Main St">
                    </div>
                    <div class="form-row">
            ...
            <div class="col-md-5">
                ...
                <table class="table your-order-table">
                    ...
                    <tr>
                        <td><img src="{{ url('/images') . '/'. $item->model->image }}" alt="" style="width: 4em"></td>
                        <td>
...
@section('script')
    <script>
        ...
        var stripe = Stripe(' pk_test_ShaPHJ5HleptBq4buKqD5NmY00mN3deywW ');
